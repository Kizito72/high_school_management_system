...
<header class="app-header"><a class="app-header__logo" href="javascript:void(0);"> <img src="logo.png" alt="Solid State High School" width="73" height="73"> </a>
