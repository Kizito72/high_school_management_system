...
<style>
body {
    background: linear-gradient(135deg, #e4e5f0, #e8e2eb);
    min-height: 100vh;
}
.login-box {
    border-radius: 20px;
...
<div class="login-box">
<a href="../index.html" class="back-button" style="position: absolute; top: 20px; left: 20px; font-size: 1.5rem; color: #1e2180; text-decoration: none; z-index: 10;"><i class="fas fa-arrow-left"></i></a>
...
<h4 class="login-head"><i class="fas fa-user-shield me-2"></i> Admin Login <?php// echo WBName; ?></h4>
<p class="text-center"><span style="font-weight: bold; font-size: 1.1rem;">Administrative Portal Access</span>
    <br>
    <Span style="color: #aa0404;" class="text-center"><i class="fas fa-exclamation-triangle me-1"></i>Authorized Personnel Only</Span>
</p>
...
<input class="form-control" type="text" placeholder="Admin Email" required name="username">
</div>
</div>
<div class="mb-3">
...
<center><img height="140" src="images/logo/<?php echo WBLogo; ?>"></center>
<h4 class="login-head">Admin Login <?php// echo WBName; ?></h4>
