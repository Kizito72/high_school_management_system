...
<title>SSHS - Announcements</title>
<meta charset="utf-8">
...
<header class="app-header"><a class="app-header__logo" href="javascript:void(0);"> <img src="logo.png" alt="Solid State High School" width="73" height="73"> </a></a>
...
<li><a class="dropdown-item" href="logout-acad-staff"><i class="bi bi-box-arrow-right me-2 fs-5"></i> Logout</a></li>
</ul>
</li>
</ul>
</header>
...
<li class="breadcrumb-item"><br><button style="background-color: #016901; border-color: #016901;" class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addModal">Add</button></li>
</ul>
</div>
...
<table class="table table-hover table-bordered" id="sshsTable">
<thead>
<tr>
<th>Title</th>
<th>Audience</th>
...
<script type="text/javascript">$('#sshsTable').DataTable({"sort" : false});</script>
