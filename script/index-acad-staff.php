...
<form class="login-form app_frm" action="core/auth-acad-staff" autocomplete="OFF" method="POST"> 
<center><img height="140" src="images/logo/<?php echo WBLogo; ?>"></center>
<h4 class="login-head"><i class="fas fa-chalkboard-teacher"></i> Academic Staff Login <?php// echo WBName; ?></h4>
<p class="text-center">Staff Portal Access
...
<input class="form-control" type="text" placeholder="Staff Email" required name="username">
</div>
</div>
<div class="mb-3">
...
<center><img height="140" src="images/logo/<?php echo WBLogo; ?>"></center>
<h4 class="login-head">Academic Staff Login <?php// echo WBName; ?></h4>
