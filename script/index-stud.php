...
<form class="login-form app_frm" action="core/auth-stud" autocomplete="OFF" method="POST">
<center><img height="140" src="images/logo/<?php echo WBLogo; ?>"></center>
<h4 class="login-head">Student Portal Login <?php// echo WBName; ?></h4>
<p class="text-center">Access Your Student Portal</p>
<div class="mb-3">
<label class="form-label">Email or Registration Number</label>
...
<center><img height="140" src="images/logo/<?php echo WBLogo; ?>"></center>
<h4 class="login-head">Student Portal <?php// echo WBName; ?></h4>
